        ...
        <div id="container" style={{
            ...
            <div className="head">
                ...
                <div className="contact">
                    ...
                    <div className="separator-inline" style={{ background: props.themeContext.text }} />
                    <li id="email">
            ...
            <div className="section">
                <div className="section-head">
                    ...
                    <div className="section-separator" style={{ background: props.themeContext.text }}></div>
                </div>
                <div className="section-inner">
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title"> <b>University of California, Berkeley</b></div>
                                <div className="subtitle">Bachelors of Arts in Computer Science (GPA 3.57)</div>
                            </div>
                            <div className="right">
                                <div className="title">Aug 2018 - May 2022 (expected)</div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="section">
                ...
                <div className="item-head">
                    <div className="technologies">Node.js, React + React Native, Express, Android Studio, Pandas, Git</div>
                    <div className="languages">Python, HTML5/CSS/JS, Java, SQL, Kotlin</div>
                </div>
            </div>
            <div className="section">
                <div className="section-head">
                ...
                <div className="section-inner">
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">Academic Intern</div>
                                <div className="subtitle">UC Berkeley (Data 100)</div>
                            </div>
                            <div className="right">
                                <div className="title">Jan 2020 - current</div>
                            </div>
                        </div>
                        <div className="description">
                    ...
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                ...
                                <div className="subtitle">Soracom Global Inc. </div>
                            </div>
                            <div className="right">
                                <div className="title">Jun 2019 - Jan 2020</div>
                            </div>
                        </div>
                        <div className="description">
                    ...
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">Mobile Developer (Android)</div>
                                <div className="subtitle">Project Loaf </div>
                            </div>
                            <div className="right">
                                <div className="title">Jun 2017 - Aug 2017 </div>
                            </div>
                        </div>
                        <div className="description">
            ...
            <div className="section">
                ...
                <div className="section-inner">
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">Augmented Reality for Visually Impaired People</div>
                                <div className="subtitle stack">Microsoft Hololens, Unity (C#), Google Cloud Vision API</div>
                            </div>
                            <div className="right">
                                <div className="title">Sep 2019 - current</div>
                            </div>
                        </div>
                        <div className="description">
                    ...
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">Bobafetch </div>
                                <div className="subtitle stack">React Native, Stripe API, Python, Microsoft Azure, Arduino, Raspberry Pi </div>
                            </div>
                            <div className="right">
                                <div className="title">Nov 2019</div>
                            </div>
                        </div>
                        <div className="description">
                    ...
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">PictRNNary </div>
                                <div className="subtitle stack">Bootstrap + JQuery, Node.js, Tensorflow, Keras, Microsoft Azure</div>
                            </div>
                            <div className="right">
                                <div className="title">Nov 2018 </div>
                            </div>
                        </div>
                        <div className="description">
                    ...
                    <div className="item">
                        <div className="item-head">
                            <div className="left">
                                <div className="title">Blindsight </div>
                                <div className="subtitle stack">Android, Node.js, Python (OpenCV), Tensorflow, Raspberry Pi </div>
                            </div>
                            <div className="right">
                                <div className="title">Sep 2018 </div>
                            </div>
                        </div>
                        <div className="description">
